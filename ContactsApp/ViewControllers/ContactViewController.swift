...
class ContactViewController: UIViewController, UINavigationControllerDelegate, UserEditable, DataReceivable{
    ...
    var wasContactVisiblyEdited : Bool?
    ...
    func passBool(wasContactVisiblyEdited: Bool) {
        self.wasContactVisiblyEdited = wasContactVisiblyEdited
    }
    ...
    /// This method sets contraints for the various UI elements, given a height fo r
    ...
    @objc func handleBackAction() {
        ...
        if let edited = self.wasContactVisiblyEdited {
            delegate?.passBool(wasContactVisiblyEdited: edited)
        } else {
            // if contactWasEdited was not set by AddContactViewController, contact has not yet been edited
            delegate?.passBool(wasContactVisiblyEdited: false)
        }
